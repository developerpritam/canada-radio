...
import { Text, View, FlatList, Image, TouchableOpacity, StatusBar, ActivityIndicator, useColorScheme, Button, NativeModules, AppState } from 'react-native'
...
// const adUnitId = 'ca-app-pub-5603289619370435/9047142972';
...
const Home = ({ navigation }) => {
  ...
  //     if (appState === 'active' && AdEventType.LOADED) {
  //       await appOpenAd.show();
  //       console.log('Ad loaded and shown successfully');
  //     }
  //   };
  ...
  const getUserData = async () => {
    try {
      const response = await fetch("https://thedailygardening.com/Canada%20Radio%20api/canadaRadio.json");
