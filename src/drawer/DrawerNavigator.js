  ...
  export const onShare = async () => {
    try {
      const result = await Share.share({
        message: 'https://play.google.com/store/apps/details?id=com.canadaradioapp',
        // === App link will here ===
      });
...
const DrawerNavigator = () => {
  ...
  return (
          ...
          return (
            <SafeAreaView style={{ flex: 1 }}>
              ...
              <DrawerItem
                ...
                label="Rate Us"
                icon={colourIcon}
                onPress={() => Linking.openURL("https://play.google.com/store/apps/details?id=com.canadaradioapp")}
              />
    ...
    >
      <Drawer.Screen name="Canada Radio" component={Home}
        options={({ navigation }) => ({
          headerStyle: {
            backgroundColor: theme === 'light' ? MyColor.white : MyColor.darkmodeBg,
          },
